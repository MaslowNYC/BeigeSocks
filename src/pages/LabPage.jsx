...
function LabPage() {
  ...
  return (
    <>
      <Helmet>
        <title>The Lab - Electronics Calculators | BeigeSocks</title>
        ...
        <div className="relative h-[300px] overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#F5F5F0] via-[#F5F5F0]/70 to-transparent flex items-end">
            <div className="max-w-7xl mx-auto px-6 py-12 w-full">
              <h1 className="text-5xl font-bold text-[#2C3E2E] mb-2">The Lab</h1>
              <p className="text-xl text-[#6B7C6B]">Electronics Calculators</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 relative">
        ...
        >
          <h3 className="text-xl font-bold text-[#2C3E2E] mb-4">Resistance Calculator</h3>
          <div className="space-y-3">
            <select
              value={resistanceBands.band1}
              onChange={(e) => setResistanceBands({ ...resistanceBands, band1: e.target.value })}
              className="w-full bg-[#F0F2EE] text-[#2C3E2E] border border-[#D4D8D0] rounded-md px-3 py-2"
            >
            ...
            <Button onClick={calculateResistance} className="w-full bg-[#8B9E7D] text-white hover:bg-[#6B8560]">
              Calculate
            </Button>
            {resistanceResult && (
              <div className="bg-white rounded-md p-3 text-center border border-[#D4D8D0]">
                <p className="text-[#8B9E7D] font-bold">{resistanceResult}</p>
              </div>
            )}
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-white rounded-xl p-6 border border-[#D4D8D0]"
        >
          <h3 className="text-xl font-bold text-[#2C3E2E] mb-4">LED Current Limiter</h3>
          <div className="space-y-3">
            <Input
              type="number"
            ...
            />
            <Button onClick={calculateLEDResistor} className="w-full bg-[#8B9E7D] text-white hover:bg-[#6B8560]">
              Calculate
            </Button>
            {ledResult && (
              <div className="bg-white rounded-md p-3 text-center border border-[#D4D8D0]">
                <p className="text-[#8B9E7D] font-bold">{ledResult}</p>
              </div>
            )}
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-white rounded-xl p-6 border border-[#D4D8D0]"
        >
          <h3 className="text-xl font-bold text-[#2C3E2E] mb-4">PWM Duty Cycle</h3>
          <div className="space-y-3">
            <Input
              type="number"
            ...
            />
            <Button onClick={calculatePWM} className="w-full bg-[#8B9E7D] text-white hover:bg-[#6B8560]">
              Calculate
            </Button>
            {pwmResult && (
              <div className="bg-white rounded-md p-3 text-center border border-[#D4D8D0]">
                <p className="text-[#8B9E7D] font-bold">{pwmResult}</p>
              </div>
            )}
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-white rounded-xl p-6 border border-[#D4D8D0]"
        >
          <h3 className="text-xl font-bold text-[#2C3E2E] mb-4">Voltage Divider</h3>
          <div className="space-y-3">
            <Input
              type="number"
              placeholder="V_in (V)"
            ...
            />
            <Button onClick={calculateVoltageDivider} className="w-full bg-[#8B9E7D] text-white hover:bg-[#6B8560]">
              Calculate
            </Button>
            {voltageResult && (
              <div className="bg-white rounded-md p-3 text-center border border-[#D4D8D0]">
                <p className="text-[#8B9E7D] font-bold">{voltageResult}</p>
              </div>
            )}
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-white rounded-xl p-6 border border-[#D4D8D0]"
        >
          <h3 className="text-xl font-bold text-[#2C3E2E] mb-4">555 Timer Calculator</h3>
          <div className="space-y-3">
            <Input
              type="number"
              placeholder="R1 (Ω)"
            ...
            />
            <Button onClick={calculate555Timer} className="w-full bg-[#8B9E7D] text-white hover:bg-[#6B8560]">
              Calculate
            </Button>
            {timer555Result && (
              <div className="bg-white rounded-md p-3 text-center border border-[#D4D8D0]">
                <p className="text-[#8B9E7D] font-bold text-sm">{timer555Result}</p>
              </div>
            )}
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-white rounded-xl p-6 border border-[#D4D8D0]"
        >
          <h3 className="text-xl font-bold text-[#2C3E2E] mb-4">Wire Gauge Helper</h3>
          <div className="space-y-3">
            <Input
              type="number"
            ...
            />
            <Button onClick={calculateWireGauge} className="w-full bg-[#8B9E7D] text-white hover:bg-[#6B8560]">
              Calculate
            </Button>
            {wireResult && (
              <div className="bg-white rounded-md p-3 text-center border border-[#D4D8D0]">
                <p className="text-[#8B9E7D] font-bold">{wireResult}</p>
              </div>
            )}
          </div>
        </motion.div>
